...
#define ONION_HTTP_INITIAL_BODY_SIZE      256
#define ONION_HTTP_MAX_BODY_SIZE          8192

#define ONION_HTTP_INITIAL_MESSAGE_SIZE  (ONION_HTTP_LINE_MAX_SIZE + ONION_HTTP_INITIAL_HEADER_SIZE + ONION_HTTP_INITIAL_BODY_SIZE)
